            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="md:col-span-1">
                        <h3 className="text-xl font-bold mb-4">About One Page Tools</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="mailto:contact@onepagetools.com" className="text-gray-400 hover:text-white">contact@onepagetools.com</a></li>
                        </ul>
                    </div>
                </div>
                <div className="mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
                    <p>&copy; 2024 One Page Tools. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
