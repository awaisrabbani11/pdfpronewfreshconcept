...
export const Header: React.FC<HeaderProps> = ({ theme, toggleTheme }) => {
    ...
    return (
        <>
            <header className={`sticky top-0 z-40 transition-shadow duration-300 bg-indigo-700 dark:bg-indigo-900 ${isScrolled ? 'shadow-lg bg-indigo-700/90 dark:bg-indigo-900/90 backdrop-blur-md' : ''}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        <a href="#" className="flex-shrink-0">
                            <h1 className="text-2xl font-bold text-white">PDFPRO.PRO</h1>
                        </a>
            ...
            {/* Mobile Menu */}
            <div className={`fixed inset-0 bg-indigo-700 dark:bg-indigo-900 z-30 transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
